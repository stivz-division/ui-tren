...
- `.codex/skills/ddd-practices/SKILL.md`
- `.codex/skills/ddd-practices/references/SOURCE-MAP.md`
...
- write each child directly under `.codex/skills/<prefix>-<child-scope>/`
...
- no writes to the current agent `.codex/skills`
...
- save to `.codex/skills/platform-operator/`
...
- confirm the resolved target path would stay under the resolved output root (`.codex/skills` by default, or `--path` when present)
