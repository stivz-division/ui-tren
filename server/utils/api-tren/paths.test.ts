...
describe('API Tren proxy allowlist', () => {
  it.each([
    ...
    ['GET', 'workout-sessions/9/analysis'],
    ['POST', 'workout-recommendations/3/apply'],
    ['POST', 'workout-recommendations/3/reject'],
  ...
  it.each([
    ...
    ['POST', 'workout-sessions/9/analysis'],
    ['POST', 'workout-sessions/9/analysis/retry'],
    ['GET', 'workout-recommendations/3/apply'],
